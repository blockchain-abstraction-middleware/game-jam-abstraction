...
const ContractRegistryABI = "[{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"string\",\"name\":\"name\",\"type\":\"string\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"contractAddress\",\"type\":\"address\"}],\"name\":\"UpdateContract\",\"type\":\"event\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"string\",\"name\":\"_name\",\"type\":\"string\"},{\"internalType\":\"address\",\"name\":\"_address\",\"type\":\"address\"}],\"name\":\"updateContractAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"string\",\"name\":\"_name\",\"type\":\"string\"}],\"name\":\"getContractAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
func (_ContractRegistry *ContractRegistryCaller) GetContractAddress(opts *bind.CallOpts, _name string) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _ContractRegistry.contract.Call(opts, out, "getContractAddress", _name)
	return *ret0, err
}
...
//
// Solidity: function getContractAddress(string _name) constant returns(address)
func (_ContractRegistry *ContractRegistrySession) GetContractAddress(_name string) (common.Address, error) {
	return _ContractRegistry.Contract.GetContractAddress(&_ContractRegistry.CallOpts, _name)
}

// GetContractAddress is a free data retrieval call binding the contract method 0x04433bbc.
//
// Solidity: function getContractAddress(string _name) constant returns(address)
func (_ContractRegistry *ContractRegistryCallerSession) GetContractAddress(_name string) (common.Address, error) {
	return _ContractRegistry.Contract.GetContractAddress(&_ContractRegistry.CallOpts, _name)
}
...
func (_ContractRegistry *ContractRegistryTransactor) UpdateContractAddress(opts *bind.TransactOpts, _name string, _address common.Address) (*types.Transaction, error) {
	return _ContractRegistry.contract.Transact(opts, "updateContractAddress", _name, _address)
}

// UpdateContractAddress is a paid mutator transaction binding the contract method 0x38aed2f7.
//
// Solidity: function updateContractAddress(string _name, address _address) returns(address)
func (_ContractRegistry *ContractRegistrySession) UpdateContractAddress(_name string, _address common.Address) (*types.Transaction, error) {
	return _ContractRegistry.Contract.UpdateContractAddress(&_ContractRegistry.TransactOpts, _name, _address)
}

// UpdateContractAddress is a paid mutator transaction binding the contract method 0x38aed2f7.
//
// Solidity: function updateContractAddress(string _name, address _address) returns(address)
func (_ContractRegistry *ContractRegistryTransactorSession) UpdateContractAddress(_name string, _address common.Address) (*types.Transaction, error) {
	return _ContractRegistry.Contract.UpdateContractAddress(&_ContractRegistry.TransactOpts, _name, _address)
}

// ContractRegistryUpdateContractIterator is returned from FilterUpdateContract and is used to iterate over the raw logs and unpacked data for UpdateContract events raised by the ContractRegistry contract.
type ContractRegistryUpdateContractIterator struct {
	Event *ContractRegistryUpdateContract // Event containing the contract specifics and raw log
...
func (it *ContractRegistryUpdateContractIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractRegistryUpdateContract)
...
func (it *ContractRegistryUpdateContractIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractRegistryUpdateContractIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractRegistryUpdateContract represents a UpdateContract event raised by the ContractRegistry contract.
type ContractRegistryUpdateContract struct {
	Name            string
	ContractAddress common.Address
	Raw             types.Log // Blockchain specific contextual infos
}

// FilterUpdateContract is a free log retrieval operation binding the contract event 0xbc3033706311de40ef10e265f8dd3d699529b780126a1c727cb205cc798cbbab.
//
// Solidity: event UpdateContract(string name, address indexed contractAddress)
func (_ContractRegistry *ContractRegistryFilterer) FilterUpdateContract(opts *bind.FilterOpts, contractAddress []common.Address) (*ContractRegistryUpdateContractIterator, error) {
	...
	logs, sub, err := _ContractRegistry.contract.FilterLogs(opts, "UpdateContract", contractAddressRule)
	if err != nil {
		return nil, err
	}
	return &ContractRegistryUpdateContractIterator{contract: _ContractRegistry.contract, event: "UpdateContract", logs: logs, sub: sub}, nil
}

// WatchUpdateContract is a free log subscription operation binding the contract event 0xbc3033706311de40ef10e265f8dd3d699529b780126a1c727cb205cc798cbbab.
//
// Solidity: event UpdateContract(string name, address indexed contractAddress)
func (_ContractRegistry *ContractRegistryFilterer) WatchUpdateContract(opts *bind.WatchOpts, sink chan<- *ContractRegistryUpdateContract, contractAddress []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ContractRegistry.contract.WatchLogs(opts, "UpdateContract", contractAddressRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ContractRegistryUpdateContract)
				if err := _ContractRegistry.contract.UnpackLog(event, "UpdateContract", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseUpdateContract is a log parse operation binding the contract event 0xbc3033706311de40ef10e265f8dd3d699529b780126a1c727cb205cc798cbbab.
//
// Solidity: event UpdateContract(string name, address indexed contractAddress)
func (_ContractRegistry *ContractRegistryFilterer) ParseUpdateContract(log types.Log) (*ContractRegistryUpdateContract, error) {
	event := new(ContractRegistryUpdateContract)
	if err := _ContractRegistry.contract.UnpackLog(event, "UpdateContract", log); err != nil {
		return nil, err
	}
